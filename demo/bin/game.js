...
awe6_core_drivers_createjs_Factory.prototype = $extend(awe6_core_drivers_AFactory.prototype,{
	...
	,_getAssetUrls: function() {
		var l_result = ["bin/assets/Blank.png","bin/assets/Circle.png","bin/assets/fonts/__Orbitron.eot","bin/assets/fonts/__Orbitron.svg","bin/assets/fonts/__orbitron.ttf","bin/assets/fonts/__Orbitron.woff","bin/assets/__Config.xml","bin/assets/__Icon128.png","bin/assets/__Icon196.png","bin/assets/__Icon256.png"];
		var l_toRemove = [];
		var _g1 = 0;
		var _g = l_result.length;
		while(_g1 < _g) {
...
var awe6_core_drivers_createjs_extras_gui_Image = function(p_kernel,p_bitmapDataUrl,p_isAdd) {
	if(p_isAdd == null) p_isAdd = false;
	this._bitmapDataUrl = p_bitmapDataUrl;
	this._isAdd = p_isAdd;
	awe6_core_drivers_createjs_extras_gui_GuiEntity.call(this,p_kernel);
};
$hxClasses["awe6.core.drivers.createjs.extras.gui.Image"] = awe6_core_drivers_createjs_extras_gui_Image;
awe6_core_drivers_createjs_extras_gui_Image.__name__ = true;
awe6_core_drivers_createjs_extras_gui_Image.__super__ = awe6_core_drivers_createjs_extras_gui_GuiEntity;
awe6_core_drivers_createjs_extras_gui_Image.prototype = $extend(awe6_core_drivers_createjs_extras_gui_GuiEntity.prototype,{
	_init: function() {
		awe6_core_drivers_createjs_extras_gui_GuiEntity.prototype._init.call(this);
		this._context.mouseEnabled = false;
		this._bitmap = new createjs.Bitmap(this._bitmapDataUrl);
		if(this._isAdd) this._bitmap.compositeOperation = "lighter"; else this._bitmap.compositeOperation = "source-over";
		this._context.addChild(this._bitmap);
		this.width = this._bitmap.image.width;
		this.height = this._bitmap.image.height;
	}
	,__class__: awe6_core_drivers_createjs_extras_gui_Image
});
...
demo_Test.prototype = $extend(awe6_core_Scene.prototype,{
	_init: function() {
		...
		this._eases = [tweezer_EEase.EASE_IN,tweezer_EEase.EASE_IN_OUT,tweezer_EEase.EASE_OUT,tweezer_EEase.EASE_OUT_IN];
		this._tweens = [tweezer_ETween.BACK(),tweezer_ETween.BOUNCE,tweezer_ETween.CIRCULAR,tweezer_ETween.CUBIC,tweezer_ETween.ELASTIC(),tweezer_ETween.EXPONENTIAL,tweezer_ETween.LINEAR,tweezer_ETween.QUADRATIC,tweezer_ETween.QUARTIC,tweezer_ETween.QUINTIC,tweezer_ETween.SINE];
		this._image = new awe6_core_drivers_createjs_extras_gui_Image(this._kernel,"assets/Circle.png");
		this._image.setPosition(0,0);
		this.addEntity(this._image,null,true,5);
		...
		this._createRandomTweezer();
	}
	,_createRandomTweezer: function() {
		var l_ease = this._eases[Std.random(this._eases.length)];
		var l_tween = this._tweens[Std.random(this._tweens.length)];
		var l_tweezer = new tweezer_Tweezer(this._kernel,$bind(this,this._updateImagePosition),-128,this._kernel.factory.width - 128,500,2000,1000,l_ease,l_tween,$bind(this,this._createRandomTweezer));
		this._image.addEntity(l_tweezer);
		this._text.set_text(this._kernel.tools.toWords(l_tween[0] + "_" + Std.string(l_ease)));
		this._kernel.overlay.flash();
	}
	,_updateImagePosition: function(p_value) {
		this._image.set_x(p_value);
	}
	,__class__: demo_Test
});
...
var tweezer_EEase = $hxClasses["tweezer.EEase"] = { __ename__ : true, __constructs__ : ["EASE_IN","EASE_IN_OUT","EASE_OUT","EASE_OUT_IN"] };
tweezer_EEase.EASE_IN = ["EASE_IN",0];
tweezer_EEase.EASE_IN.toString = $estr;
tweezer_EEase.EASE_IN.__enum__ = tweezer_EEase;
tweezer_EEase.EASE_IN_OUT = ["EASE_IN_OUT",1];
tweezer_EEase.EASE_IN_OUT.toString = $estr;
tweezer_EEase.EASE_IN_OUT.__enum__ = tweezer_EEase;
tweezer_EEase.EASE_OUT = ["EASE_OUT",2];
tweezer_EEase.EASE_OUT.toString = $estr;
tweezer_EEase.EASE_OUT.__enum__ = tweezer_EEase;
tweezer_EEase.EASE_OUT_IN = ["EASE_OUT_IN",3];
tweezer_EEase.EASE_OUT_IN.toString = $estr;
tweezer_EEase.EASE_OUT_IN.__enum__ = tweezer_EEase;
var tweezer_ETween = $hxClasses["tweezer.ETween"] = { __ename__ : true, __constructs__ : ["BACK","BOUNCE","CIRCULAR","CUBIC","ELASTIC","EXPONENTIAL","LINEAR","QUADRATIC","QUARTIC","QUINTIC","SINE"] };
tweezer_ETween.BACK = function(p_overshoot) { var $x = ["BACK",0,p_overshoot]; $x.__enum__ = tweezer_ETween; $x.toString = $estr; return $x; };
tweezer_ETween.BOUNCE = ["BOUNCE",1];
tweezer_ETween.BOUNCE.toString = $estr;
tweezer_ETween.BOUNCE.__enum__ = tweezer_ETween;
tweezer_ETween.CIRCULAR = ["CIRCULAR",2];
tweezer_ETween.CIRCULAR.toString = $estr;
tweezer_ETween.CIRCULAR.__enum__ = tweezer_ETween;
tweezer_ETween.CUBIC = ["CUBIC",3];
tweezer_ETween.CUBIC.toString = $estr;
tweezer_ETween.CUBIC.__enum__ = tweezer_ETween;
tweezer_ETween.ELASTIC = function(p_period,p_amplitude) { var $x = ["ELASTIC",4,p_period,p_amplitude]; $x.__enum__ = tweezer_ETween; $x.toString = $estr; return $x; };
tweezer_ETween.EXPONENTIAL = ["EXPONENTIAL",5];
tweezer_ETween.EXPONENTIAL.toString = $estr;
tweezer_ETween.EXPONENTIAL.__enum__ = tweezer_ETween;
tweezer_ETween.LINEAR = ["LINEAR",6];
tweezer_ETween.LINEAR.toString = $estr;
tweezer_ETween.LINEAR.__enum__ = tweezer_ETween;
tweezer_ETween.QUADRATIC = ["QUADRATIC",7];
tweezer_ETween.QUADRATIC.toString = $estr;
tweezer_ETween.QUADRATIC.__enum__ = tweezer_ETween;
tweezer_ETween.QUARTIC = ["QUARTIC",8];
tweezer_ETween.QUARTIC.toString = $estr;
tweezer_ETween.QUARTIC.__enum__ = tweezer_ETween;
tweezer_ETween.QUINTIC = ["QUINTIC",9];
tweezer_ETween.QUINTIC.toString = $estr;
tweezer_ETween.QUINTIC.__enum__ = tweezer_ETween;
tweezer_ETween.SINE = ["SINE",10];
tweezer_ETween.SINE.toString = $estr;
tweezer_ETween.SINE.__enum__ = tweezer_ETween;
var tweezer_TweenFactory = function() { };
$hxClasses["tweezer.TweenFactory"] = tweezer_TweenFactory;
tweezer_TweenFactory.__name__ = true;
tweezer_TweenFactory.createTweenFunction = function(p_startingValue,p_changeInValue,p_duration,p_easeType,p_tweenType) {
	if(p_easeType == null) p_easeType = tweezer_EEase.EASE_IN;
	if(p_tweenType == null) p_tweenType = tweezer_ETween.LINEAR;
	switch(p_tweenType[1]) {
	case 0:
		var p_overshoot = p_tweenType[2];
		if(p_overshoot == null) p_overshoot = 1.70158;
		switch(p_easeType[1]) {
		case 0:
			return function(p_value) {
				return tweezer_tweens_Back.easeIn(p_value,p_startingValue,p_changeInValue,p_duration,p_overshoot);
			};
		case 1:
			return function(p_value1) {
				return tweezer_tweens_Back.easeInOut(p_value1,p_startingValue,p_changeInValue,p_duration,p_overshoot);
			};
		case 2:
			return function(p_value2) {
				return tweezer_tweens_Back.easeOut(p_value2,p_startingValue,p_changeInValue,p_duration,p_overshoot);
			};
		case 3:
			return function(p_value3) {
				return tweezer_tweens_Back.easeOutIn(p_value3,p_startingValue,p_changeInValue,p_duration,p_overshoot);
			};
		}
		break;
	case 1:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value4) {
				return tweezer_tweens_Bounce.easeIn(p_value4,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value5) {
				return tweezer_tweens_Bounce.easeInOut(p_value5,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value6) {
				return tweezer_tweens_Bounce.easeOut(p_value6,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value7) {
				return tweezer_tweens_Bounce.easeOutIn(p_value7,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 2:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value8) {
				return tweezer_tweens_Circular.easeIn(p_value8,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value9) {
				return tweezer_tweens_Circular.easeInOut(p_value9,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value10) {
				return tweezer_tweens_Circular.easeOut(p_value10,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value11) {
				return tweezer_tweens_Circular.easeOutIn(p_value11,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 3:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value12) {
				return tweezer_tweens_Cubic.easeIn(p_value12,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value13) {
				return tweezer_tweens_Cubic.easeInOut(p_value13,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value14) {
				return tweezer_tweens_Cubic.easeOut(p_value14,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value15) {
				return tweezer_tweens_Cubic.easeOutIn(p_value15,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 4:
		var p_amplitude = p_tweenType[3];
		var p_period = p_tweenType[2];
		if(p_period == null) p_period = p_duration * .3 * (p_easeType == tweezer_EEase.EASE_IN_OUT?1.5:1);
		if(p_amplitude == null) p_amplitude = 0;
		switch(p_easeType[1]) {
		case 0:
			return function(p_value16) {
				return tweezer_tweens_Elastic.easeIn(p_value16,p_startingValue,p_changeInValue,p_duration,p_period,p_amplitude);
			};
		case 1:
			return function(p_value17) {
				return tweezer_tweens_Elastic.easeInOut(p_value17,p_startingValue,p_changeInValue,p_duration,p_period,p_amplitude);
			};
		case 2:
			return function(p_value18) {
				return tweezer_tweens_Elastic.easeOut(p_value18,p_startingValue,p_changeInValue,p_duration,p_period,p_amplitude);
			};
		case 3:
			return function(p_value19) {
				return tweezer_tweens_Elastic.easeOutIn(p_value19,p_startingValue,p_changeInValue,p_duration,p_period,p_amplitude);
			};
		}
		break;
	case 5:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value20) {
				return tweezer_tweens_Exponential.easeIn(p_value20,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value21) {
				return tweezer_tweens_Exponential.easeInOut(p_value21,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value22) {
				return tweezer_tweens_Exponential.easeOut(p_value22,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value23) {
				return tweezer_tweens_Exponential.easeOutIn(p_value23,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 6:
		return function(p_value24) {
			return tweezer_tweens_Linear.ease(p_value24,p_startingValue,p_changeInValue,p_duration);
		};
	case 7:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value25) {
				return tweezer_tweens_Quadratic.easeIn(p_value25,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value26) {
				return tweezer_tweens_Quadratic.easeInOut(p_value26,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value27) {
				return tweezer_tweens_Quadratic.easeOut(p_value27,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value28) {
				return tweezer_tweens_Quadratic.easeOutIn(p_value28,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 8:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value29) {
				return tweezer_tweens_Quartic.easeIn(p_value29,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value30) {
				return tweezer_tweens_Quartic.easeInOut(p_value30,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value31) {
				return tweezer_tweens_Quartic.easeOut(p_value31,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value32) {
				return tweezer_tweens_Quartic.easeOutIn(p_value32,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 9:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value33) {
				return tweezer_tweens_Quintic.easeIn(p_value33,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value34) {
				return tweezer_tweens_Quintic.easeInOut(p_value34,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value35) {
				return tweezer_tweens_Quintic.easeOut(p_value35,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value36) {
				return tweezer_tweens_Quintic.easeOutIn(p_value36,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	case 10:
		switch(p_easeType[1]) {
		case 0:
			return function(p_value37) {
				return tweezer_tweens_Sine.easeIn(p_value37,p_startingValue,p_changeInValue,p_duration);
			};
		case 1:
			return function(p_value38) {
				return tweezer_tweens_Sine.easeInOut(p_value38,p_startingValue,p_changeInValue,p_duration);
			};
		case 2:
			return function(p_value39) {
				return tweezer_tweens_Sine.easeOut(p_value39,p_startingValue,p_changeInValue,p_duration);
			};
		case 3:
			return function(p_value40) {
				return tweezer_tweens_Sine.easeOutIn(p_value40,p_startingValue,p_changeInValue,p_duration);
			};
		}
		break;
	}
};
var tweezer_Tweezer = function(p_kernel,p_updateCallback,p_startValue,p_endValue,p_startDelay,p_duration,p_endDelay,p_easeType,p_tweenType,p_completeCallback,p_isSnap) {
	if(p_endDelay == null) p_endDelay = 0;
	if(p_duration == null) p_duration = 1000;
	if(p_startDelay == null) p_startDelay = 0;
	this._updateCallback = p_updateCallback;
	this._startValue = p_startValue;
	this._endValue = p_endValue;
	this._startDelay = p_startDelay;
	this._duration = p_duration;
	this._endDelay = p_endDelay;
	this._easeType = p_easeType;
	this._tweenType = p_tweenType;
	this._completeCallback = p_completeCallback;
	this._isSnap = p_isSnap;
	awe6_core_Entity.call(this,p_kernel);
	this._updater();
	this._updates = 0;
};
$hxClasses["tweezer.Tweezer"] = tweezer_Tweezer;
tweezer_Tweezer.__name__ = true;
tweezer_Tweezer.__super__ = awe6_core_Entity;
tweezer_Tweezer.prototype = $extend(awe6_core_Entity.prototype,{
	_init: function() {
		awe6_core_Entity.prototype._init.call(this);
		this._tweenFunction = tweezer_TweenFactory.createTweenFunction(this._startValue,this._endValue - this._startValue,this._duration,this._easeType,this._tweenType);
	}
	,_updater: function(p_deltaTime) {
		if(p_deltaTime == null) p_deltaTime = 0;
		awe6_core_Entity.prototype._updater.call(this,p_deltaTime);
		if(this._updateCallback != null) {
			var l_value = this._tweenFunction(Math.min(Math.max(0,this._age - this._startDelay),this._duration));
			this._updateCallback(this._isSnap?Math.round(l_value):l_value);
		}
		if(this._age >= this._startDelay + this._duration + this._endDelay) {
...
$hxClasses["tweezer.tweens.Back"] = tweezer_tweens_Back;
tweezer_tweens_Back.__name__ = true;
tweezer_tweens_Back.easeIn = function(t,b,c,d,p_overshoot) {
	return c * (t /= d) * t * ((p_overshoot + 1) * t - p_overshoot) + b;
};
tweezer_tweens_Back.easeOut = function(t,b,c,d,p_overshoot) {
	return c * ((t = t / d - 1) * t * ((p_overshoot + 1) * t + p_overshoot) + 1) + b;
};
tweezer_tweens_Back.easeInOut = function(t,b,c,d,p_overshoot) {
	if((t /= d / 2) < 1) return c / 2 * (t * t * (((p_overshoot *= 1.525) + 1) * t - p_overshoot)) + b;
	return c / 2 * ((t -= 2) * t * (((p_overshoot *= 1.525) + 1) * t + p_overshoot) + 2) + b;
};
tweezer_tweens_Back.easeOutIn = function(t,b,c,d,p_overshoot) {
	if(t < d / 2) return tweezer_tweens_Back.easeOut(t * 2,b,c / 2,d,p_overshoot);
	return tweezer_tweens_Back.easeIn(t * 2 - d,b + c / 2,c / 2,d,p_overshoot);
};
var tweezer_tweens_Bounce = function() { };
$hxClasses["tweezer.tweens.Bounce"] = tweezer_tweens_Bounce;
tweezer_tweens_Bounce.__name__ = true;
tweezer_tweens_Bounce.easeIn = function(t,b,c,d) {
	return c - tweezer_tweens_Bounce.easeOut(d - t,0,c,d) + b;
};
tweezer_tweens_Bounce.easeOut = function(t,b,c,d) {
...
tweezer_tweens_Bounce.easeInOut = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Bounce.easeIn(t * 2,0,c,d) * .5 + b; else return tweezer_tweens_Bounce.easeOut(t * 2 - d,0,c,d) * .5 + c * .5 + b;
};
tweezer_tweens_Bounce.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Bounce.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Bounce.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Circular = function() { };
$hxClasses["tweezer.tweens.Circular"] = tweezer_tweens_Circular;
tweezer_tweens_Circular.__name__ = true;
tweezer_tweens_Circular.easeIn = function(t,b,c,d) {
	return -c * (Math.sqrt(1 - (t /= d) * t) - 1) + b;
};
tweezer_tweens_Circular.easeOut = function(t,b,c,d) {
	return c * Math.sqrt(1 - (t = t / d - 1) * t) + b;
};
tweezer_tweens_Circular.easeInOut = function(t,b,c,d) {
	if((t /= d / 2) < 1) return -c / 2 * (Math.sqrt(1 - t * t) - 1) + b;
	return c / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + b;
};
tweezer_tweens_Circular.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Circular.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Circular.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Cubic = function() { };
$hxClasses["tweezer.tweens.Cubic"] = tweezer_tweens_Cubic;
tweezer_tweens_Cubic.__name__ = true;
tweezer_tweens_Cubic.easeIn = function(t,b,c,d) {
	return c * (t /= d) * t * t + b;
};
tweezer_tweens_Cubic.easeOut = function(t,b,c,d) {
	return c * ((t = t / d - 1) * t * t + 1) + b;
};
tweezer_tweens_Cubic.easeInOut = function(t,b,c,d) {
	if((t /= d / 2) < 1) return c / 2 * t * t * t + b;
	return c / 2 * ((t -= 2) * t * t + 2) + b;
};
tweezer_tweens_Cubic.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Cubic.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Cubic.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Elastic = function() { };
$hxClasses["tweezer.tweens.Elastic"] = tweezer_tweens_Elastic;
tweezer_tweens_Elastic.__name__ = true;
tweezer_tweens_Elastic.easeIn = function(t,b,c,d,p_period,p_amplitude) {
	if(t == 0) return b;
	if((t /= d) == 1) return b + c;
	var l_s;
	if(p_amplitude == 0 || p_amplitude < Math.abs(c)) {
		p_amplitude = c;
		l_s = p_period / 4;
	} else l_s = p_period / (2 * Math.PI) * Math.asin(c / p_amplitude);
	return -(p_amplitude * Math.pow(2,10 * (t -= 1)) * Math.sin((t * d - l_s) * (2 * Math.PI) / p_period)) + b;
};
tweezer_tweens_Elastic.easeOut = function(t,b,c,d,p_period,p_amplitude) {
	if(t == 0) return b;
	if((t /= d) == 1) return b + c;
	var l_s;
	if(p_amplitude == 0 || p_amplitude < Math.abs(c)) {
...
tweezer_tweens_Elastic.easeInOut = function(t,b,c,d,p_period,p_amplitude) {
	if(t == 0) return b;
	...
	if(t < 1) return -0.5 * (p_amplitude * Math.pow(2,10 * (t -= 1)) * Math.sin((t * d - l_s) * (2 * Math.PI) / p_period)) + b;
	return p_amplitude * Math.pow(2,-10 * (t -= 1)) * Math.sin((t * d - l_s) * (2 * Math.PI) / p_period) * .5 + c + b;
};
tweezer_tweens_Elastic.easeOutIn = function(t,b,c,d,p_period,p_amplitude) {
	if(t < d / 2) return tweezer_tweens_Elastic.easeOut(t * 2,b,c / 2,d,p_period,p_amplitude);
	return tweezer_tweens_Elastic.easeIn(t * 2 - d,b + c / 2,c / 2,d,p_period,p_amplitude);
};
var tweezer_tweens_Exponential = function() { };
$hxClasses["tweezer.tweens.Exponential"] = tweezer_tweens_Exponential;
tweezer_tweens_Exponential.__name__ = true;
tweezer_tweens_Exponential.easeIn = function(t,b,c,d) {
	if(t == 0) return b; else return c * Math.pow(2,10 * (t / d - 1)) + b - c * 0.001;
};
tweezer_tweens_Exponential.easeOut = function(t,b,c,d) {
	if(t == d) return b + c; else return c * 1.001 * (-Math.pow(2,-10 * t / d) + 1) + b;
};
tweezer_tweens_Exponential.easeInOut = function(t,b,c,d) {
	if(t == 0) return b;
	if(t == d) return b + c;
	if((t /= d / 2) < 1) return c / 2 * Math.pow(2,10 * (t - 1)) + b - c * 0.0005;
	return c / 2 * 1.0005 * (-Math.pow(2,-10 * --t) + 2) + b;
};
tweezer_tweens_Exponential.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Exponential.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Exponential.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Linear = function() { };
$hxClasses["tweezer.tweens.Linear"] = tweezer_tweens_Linear;
tweezer_tweens_Linear.__name__ = true;
tweezer_tweens_Linear.ease = function(t,b,c,d) {
	return c * t / d + b;
};
var tweezer_tweens_Quadratic = function() { };
$hxClasses["tweezer.tweens.Quadratic"] = tweezer_tweens_Quadratic;
tweezer_tweens_Quadratic.__name__ = true;
tweezer_tweens_Quadratic.easeIn = function(t,b,c,d) {
	return c * (t /= d) * t + b;
};
tweezer_tweens_Quadratic.easeOut = function(t,b,c,d) {
	return -c * (t /= d) * (t - 2) + b;
};
tweezer_tweens_Quadratic.easeInOut = function(t,b,c,d) {
	if((t /= d / 2) < 1) return c / 2 * t * t + b;
	return -c / 2 * (--t * (t - 2) - 1) + b;
};
tweezer_tweens_Quadratic.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Quadratic.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Quadratic.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Quartic = function() { };
$hxClasses["tweezer.tweens.Quartic"] = tweezer_tweens_Quartic;
tweezer_tweens_Quartic.__name__ = true;
tweezer_tweens_Quartic.easeIn = function(t,b,c,d) {
	return c * (t /= d) * t * t * t + b;
};
tweezer_tweens_Quartic.easeOut = function(t,b,c,d) {
	return -c * ((t = t / d - 1) * t * t * t - 1) + b;
};
tweezer_tweens_Quartic.easeInOut = function(t,b,c,d) {
	if((t /= d / 2) < 1) return c / 2 * t * t * t * t + b;
	return -c / 2 * ((t -= 2) * t * t * t - 2) + b;
};
tweezer_tweens_Quartic.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Quartic.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Quartic.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Quintic = function() { };
$hxClasses["tweezer.tweens.Quintic"] = tweezer_tweens_Quintic;
tweezer_tweens_Quintic.__name__ = true;
tweezer_tweens_Quintic.easeIn = function(t,b,c,d) {
	return c * (t /= d) * t * t * t * t + b;
};
tweezer_tweens_Quintic.easeOut = function(t,b,c,d) {
	return c * ((t = t / d - 1) * t * t * t * t + 1) + b;
};
tweezer_tweens_Quintic.easeInOut = function(t,b,c,d) {
	if((t /= d / 2) < 1) return c / 2 * t * t * t * t * t + b;
	return c / 2 * ((t -= 2) * t * t * t * t + 2) + b;
};
tweezer_tweens_Quintic.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Quintic.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Quintic.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
var tweezer_tweens_Sine = function() { };
$hxClasses["tweezer.tweens.Sine"] = tweezer_tweens_Sine;
tweezer_tweens_Sine.__name__ = true;
tweezer_tweens_Sine.easeIn = function(t,b,c,d) {
	return -c * Math.cos(t / d * (Math.PI / 2)) + c + b;
};
tweezer_tweens_Sine.easeOut = function(t,b,c,d) {
	return c * Math.sin(t / d * (Math.PI / 2)) + b;
};
tweezer_tweens_Sine.easeInOut = function(t,b,c,d) {
	return -c / 2 * (Math.cos(Math.PI * t / d) - 1) + b;
};
tweezer_tweens_Sine.easeOutIn = function(t,b,c,d) {
	if(t < d / 2) return tweezer_tweens_Sine.easeOut(t * 2,b,c / 2,d);
	return tweezer_tweens_Sine.easeIn(t * 2 - d,b + c / 2,c / 2,d);
};
...
var Enum = { };
haxe_Resource.content = [{ name : "config", data : ""}];
var __map_reserved = {}
